...
enum TextChangedReason {
  /// Whether the text in an [AutoSuggestBoxCustom] was changed by user input
  userInput,

  /// Whether the text in an [AutoSuggestBoxCustom] was changed because the user
  /// chose the suggestion
  suggestionChosen,

  /// Whether the text in an [AutoSuggestBoxCustom] was cleared by the user
  cleared,
}
...
/// An item used in [AutoSuggestBoxCustom]
...
class AutoSuggestBoxCustom<T> extends StatefulWidget {
  /// Creates a fluent-styled auto suggest box.
  const AutoSuggestBoxCustom({
    super.key,
    required this.items,
    this.controller,
    this.onChanged,
  ...
  const AutoSuggestBoxCustom.form({
    super.key,
    required this.items,
    this.controller,
    this.onChanged,
  ...
  /// See also:
  ///
  ///  * [AutoSuggestBoxCustom.defaultItemSorter], the default item sorter
  ...
  @override
  State<AutoSuggestBoxCustom<T>> createState() =>
      AutoSuggestBoxCustomState<T>();
...
class AutoSuggestBoxCustomState<T> extends State<AutoSuggestBoxCustom<T>> {
  ...
  @override
  void didUpdateWidget(covariant AutoSuggestBoxCustom<T> oldWidget) {
    {
